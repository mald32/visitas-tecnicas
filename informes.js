...
const COLORES_LOTE = ["#6f4a2c", "#c9772e", "#3a6ea5", "#8a4fa0", "#5c7a3a", "#2e8a8a"];
...
<style>
:root{
  --principal:#7a4a26; --principal-oscuro:#4a2f18; --fondo-suave:#f5efe6;
  --gris:#5c534a; --borde:#ddd0c0; --rojo:#8c2f21; --texto:#241c15;
}
*{box-sizing:border-box;}
html,body{background:#fff;}
body{font-family:-apple-system,"Segoe UI",Roboto,Arial,sans-serif;max-width:860px;margin:0 auto;padding:36px 28px 50px;color:var(--texto);}
